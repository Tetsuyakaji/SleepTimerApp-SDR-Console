This program was created after reading forums that sdr console didn't have a sleep function. This gives you a method shutdown a selected process from task manager and create and the lower portion allows you to browse for an executable and start it at a specific time. The program saves the alarm program in memory so you don't have to search each time.
